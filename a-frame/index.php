    ...
    <main class="container">
      <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          <h1>A-Frame Exhibit</h1>
          <p>
            Elaborate digital art scapes using digitally-rendered art pieces and photos of physical art works
            programmed by and created by <?php echo $name ?> using the A-Frame WebVR framework and JavaScript.
          </p>
        </div>
      </div>
      ...
      <?php if (empty($artPieces)): ?>
        <div class="row">
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <p class="text-center">No A-Frame art pieces available at this time.</p>
          </div>
        </div>
      <?php else: ?>
        <?php foreach ($artPieces as $index => $piece): ?>
          ...
          <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
            ...
            <?php else: ?>
              <iframe
                src="<?php echo htmlspecialchars($piece['file_path']); ?>"
