...
function createAndRenderSphere(imageUrl) {
  ...
  textureLoader.load(imageUrl, function(texture) {
    ...
    const geometry = new THREE.SphereGeometry((Math.random() * 5), (Math.random() * 5), (Math.random() * 5));
...
cubes.forEach(createAndRenderSphere);
